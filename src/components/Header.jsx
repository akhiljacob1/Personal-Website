...
function ModeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-primary-text-primary-C-lighter/10 [@media_not_(prefers-color-scheme:dark)]:stroke-primary-C" />
    </button>
  )
}
